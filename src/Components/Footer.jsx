const footer = () => {
  return (
    <footer
      className="bg-black p-10 lg:p-16 pb-0 lg:pb-0 relative z-10 wow fadeInUp"
      data-wow-delay=".15s"
    >
        ...
        <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
          <div className="w-full mb-10">
            <a href="#!" className="inline-block max-w-[160px] mb-6">
              <img src="/assets/logo.png" alt="logo" className="max-w-full" />
            </a>
            ...
            <div className="my-1">
              <div
                className="
                    ...
                    "
              >
                <span className="text-base text-xl text-blue-500 text-[#f3f4fe] hover:text-primary px-3">
                  Created by :
                </span>
                <a
